                ...
                <div class="col-md-9">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control fw-bold" 
                               placeholder="اكتب اسم العميل أو رقم الفاتورة للفلترة الفورية..." 
                               value="<?php echo $search; ?>" style="height: 60px; font-size: 20px;">
                    </div>
                </div>
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary btn-lg w-100 fw-bold" style="height: 60px;">تطبيق الفلتر</button>
                </div>
            </form>
