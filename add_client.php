                ...
                <div class="card p-5 shadow-lg" style="border-radius: 25px; border: 2px solid #2c3e50; margin-top: 30px;">
                    ...
                    <form action="save_client.php" method="POST" id="clientForm">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" name="name" class="form-control fw-bold" placeholder="أدخل اسم العميل ..." required style="height: 60px; font-size: 20px;">
                        </div>

                        <div class="form-group mb-5">
                            <label class="mb-3 fs-4">رقم الهاتف:</label>
                            <input type="text" name="phone" class="form-control fw-bold" placeholder="ادخل رقم الهاتف" required style="height: 60px; font-size: 20px;">
                        </div>

                        <div class="form-group mb-5">
                            <label class="mb-3 fs-4">السكن / العنوان:</label>
                            <input type="text" name="address" class="form-control fw-bold" placeholder="المدينة  " required style="height: 60px; font-size: 20px;">
                        </div>
